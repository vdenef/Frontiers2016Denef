...
#one env factor at a time: Fraction -- partial Mantel not significant
...
"Fraction", "DayNight","Lake", "Shore", "Depth_Q"
...
#now plot data, sorting the otus based on how different SuFaPA ratio is from SpPA
...
drivingOTUsSpvsSuFa_noMLB <- ggplot(cDD_diff, aes(x=Species, y=log2FoldChange, color=Habitat, shape = Habitat, size=15)) + 
    geom_point(alpha=1) + theme_bw() +  #ggtitle(title) +  
    scale_color_manual(name = "Habitat", breaks=c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"),
                     labels = c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"), 
                     values = c("SpPA" = "black", "SpFL" = "black",  "SuFaPA" = "darkorange", "SuFaFL" = "black")) +
    scale_shape_manual(name = "Habitat", breaks=c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"),
                     labels = c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"), 
                     values = c("SpPA" = 16, "SpFL" = 1,  "SuFaPA" = 17, "SuFaFL" = 2)) +
...
pdf(file="Figures/Rplot_cDvsD_FL_noscale_top200.pdf", width= 10, height=7.5, pointsize= 14, useDingbats=FALSE)
...
## would be good to work toward a figure with boxplots for cDNA, DNA, and cD2D data for each OTU, ordered by decreasing CV only including OTUs detected in x% of samples ### Make line plots like Michelle
