...
pdf(file="Figures/Rplot_cDvsD_FL_noscale_top200.pdf", width= 20, height=15, pointsize= 14, useDingbats=FALSE)
...
## would be good to work toward a figure with boxplots for cDNA, DNA, and cD2D data for each OTU, ordered by decreasing CV only including OTUs detected in x% of samples
