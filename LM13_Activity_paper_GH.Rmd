...
pdf(file="Figures/Rplot_PCOA12_BC_toptaxa_DNA.pdf", width= 20, height=15, pointsize= 14)
pcoa_BC12_toptaxa_DNA <- ggplot(bray_pcoa4_toptaxa_DNA, aes(Axis.1, Axis.2 * -1, color = Season, shape = Station, size = Fraction, fill = Depth_Seas)) +
...
pdf(file="Figures/Rplot_PCOA34_BC_toptaxa_DNA.pdf", width= 20, height=15, pointsize= 14)
...
pdf(file="Figures/Rplot_PCOA12_BC_toptaxa_RNA.pdf", width= 20, height=15, pointsize= 14)
...
pdf(file="Figures/Rplot_PCOA34_BC_toptaxa_RNA.pdf", width= 20, height=15, pointsize= 14)
...
pdf(file="Figures/Rplot_cDD_PCOA12_EUC_toptaxa.pdf", width= 20, height=15, pointsize= 14)
...
pdf(file="Figures/Rplot_cDD_PCOA34_EUC_toptaxa.pdf", width= 20, height=15, pointsize= 14)
...
#now plot data
  y = tapply(cDD_diff$log2FoldChange, cDD_diff$Species, function(x) max(x))
  y = sort(y, TRUE)
  cDD_diff$Species = factor(as.character(cDD_diff$Species), levels=names(y))
  ggplot(cDD_diff, aes(x=Species, y=log2FoldChange, color=Habitat, size=15)) + 
    geom_jitter(position = position_jitter(width = .5)) + theme_bw() +  #ggtitle(title) +  
    scale_color_manual(name = "Habitat", breaks=c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"),
                     labels = c("SpPA", "SpFL",  "SuFaPA", "SuFaFL"), 
                     values = c("SpPA" = "darkgreen", "SpFL" = "chartreuse4",  "SuFaPA" = "darkorange", "SuFaFL" = "red")) +
